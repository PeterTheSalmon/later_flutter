...
#ifndef RECEIVE_SHARING_INTENT_SWIFT_H
#define RECEIVE_SHARING_INTENT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="receive_sharing_intent",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22receive_sharing_intent31SwiftReceiveSharingIntentPlugin")
@interface SwiftReceiveSharingIntentPlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
